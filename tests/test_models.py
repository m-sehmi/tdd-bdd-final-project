...
class TestProductModel(unittest.TestCase):
    ...
    def test_find_by_name_no_results(self):
        """It should return empty when no products match name"""
        found = Product.find_by_name("does-not-exist")
        self.assertEqual(found.count(), 0)

    def test_find_by_availability_no_results(self):
        """It should return empty when no products match availability"""
        found = Product.find_by_availability(True)
        self.assertEqual(found.count(), 0)

    def test_find_by_category_no_results(self):
        """It should return empty when no products match category"""
    ...
    def test_deserialize_missing_name(self):
        """It should not deserialize when name is missing"""
        product = Product()
        data = {
            "description": "desc",
            "price": 10,
